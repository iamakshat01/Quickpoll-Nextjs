    ...
    return (
        <div className="container mx-auto mt-10 max-w-xs">
            ...
            <form onSubmit={handleSubmit}>
                <div>
                    <label htmlFor="name" className="text-md font-medium text-gray-900 block mb-2 ">Name</label>
                    <input type="string" name="name" value={values.name} onChange={onChange} id="name" required className="bg-gray-50 border border-gray-400 text-gray-900 
